...
//go:embed fonts/ibm-plex-sans-v19-latin_latin-ext-regular.woff2 fonts/ibm-plex-sans-v19-latin_latin-ext-italic.woff2 fonts/ibm-plex-sans-v19-latin_latin-ext-500.woff2 fonts/ibm-plex-sans-v19-latin_latin-ext-700.woff2 fonts/ibm-plex-sans-v19-latin_latin-ext-600.woff2 fonts/ibm-plex-sans-v19-latin_latin-ext-600.ttf
//go:embed img/frame.svg img/frame0.png img/histories.png img/revolving.png img/7373.svg img/title_??_1024x117.png img/border*.png img/title_background*.png img/edge*.png img/image_mask.png img/120px-DeepL_logo.svg.png img/prev*.png img/next*.png img/?.png img/??.png img/hook.png img/line_medium.png img/line_short.png img/ki.png img/ki2.png img/lupe.png img/prev2.png
